  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-900 text-gray-100">
      ...
      <div className="relative group h-[160px] w-[160px] rounded-full overflow-hidden shadow-lg">
        ...
        {/* Blue + Button */}
        <div hidden={image} className="absolute z-30 bottom-2 right-2 bg-blue-500 hover:bg-blue-600 transition-all duration-200 h-[42px] w-[42px] flex items-center justify-center rounded-full shadow-md">
